...
int main() {
  Rectangle *rectangle = new Rectangle{{(double) 2, (double) 4}, 7, 10};  //создание прямоугольника
  ...
  rectangle->move({(double) -3, (double) -3});  //перемещение по координатам и дальнейший вывод текущего положения
  std::cout << "-- to point : (" << rectangle->getCenter().x << " , " << rectangle->getCenter().y << ")" << std::endl;
  rectangle->move((double) 3, (double) 3);  //перемещение по смещению и дальнейший вывод текущего положения
  std::cout << "-- by offset : (" << rectangle->getCenter().x << " , " << rectangle->getCenter().y << ")" << std::endl;
  delete (rectangle);

  std::cout << "___________________________" << std::endl;

  Circle *circle = new Circle{{(double) 2, (double) 4}, 5}; //создание круга
  ...
  std::cout << std::endl << "{Moving}" << std::endl;
  circle->move({(double) 3, (double) 3}); //перемещение по координатам и дальнейший вывод текущего положения
  std::cout << "-- to point : (" << circle->getCenter().x << " , " << circle->getCenter().y << ")" << std::endl;
  circle->move((double) 3, (double) 3); //перемещение по смещению и дальнейший вывод текущего положения
