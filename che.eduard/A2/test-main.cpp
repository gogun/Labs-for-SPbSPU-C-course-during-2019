...
BOOST_AUTO_TEST_CASE(Circle_Immutability_After_Moving)
{
  ...
  BOOST_CHECK_CLOSE(RectBeforeMoving.width, testCircle.getFrameRect().width, ACCURACY);
  BOOST_CHECK_CLOSE(RectBeforeMoving.height, testCircle.getFrameRect().height, ACCURACY);
