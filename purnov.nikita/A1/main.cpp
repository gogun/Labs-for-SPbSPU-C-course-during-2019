...
int main()
{
  ...
  std::cout << "Obtaining information about the first object (using polymorphism):" << std::endl;
  Shape *shape_1 = &circle_1;
  shape_1->printInfo();

  std::cout << "Check the coordinates of the circle:" << std::endl;
  circle_1.printInfo();
  std::cout << std::endl;
  ...
  std::cout << "Obtaining information about the second object (using polymorphism):" << std::endl;
