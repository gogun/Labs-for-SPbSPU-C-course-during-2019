...
{
  const double xMax = std::max({point1_.x,point2_.x,point3_.x}, [](double number1, double number2) { return number1 <= number2; });
  const double xMin = std::min({point1_.x,point2_.x,point3_.x}, [](double number1, double number2) { return number1 <= number2; });
  const double yMax = std::max({point1_.y,point2_.y,point3_.y}, [](double number1, double number2) { return number1 <= number2; });
  const double yMin = std::min({point1_.y,point2_.y,point3_.y}, [](double number1, double number2) { return number1 <= number2; });
